...
def CNN(input_x, input_y,input_variables,
...
def cnn_training(X_train, y_train, X_trainvar,X_val, y_val,X_valvar,
             addedvar_num=5000,
    ...
    output,loss=CNN(xs,ys,xvar,img_len=imglen, channel_num=4, output_size=2,conv_featmap=conv_featmap,fc_units=fc_units,conv_kernel_size=[5, 5], pooling_size=[2,2],l2_norm=l2_norm, seed=seed)
