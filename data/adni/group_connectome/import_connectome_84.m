function connectome = import_connectome_84(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   CONNECTOMEAPARCASEGLENGTH109S45941MMFLAIR = IMPORTFILE(FILENAME) Reads
%   data from text file FILENAME for the default selection.
%
%   CONNECTOMEAPARCASEGLENGTH109S45941MMFLAIR = IMPORTFILE(FILENAME,
%   STARTROW, ENDROW) Reads data from rows STARTROW through ENDROW of text
%   file FILENAME.
%
% Example:
%   connectomeaparcaseglength109S45941mmflair = importfile('connectome_aparc+aseg_length_109_S_4594_1mm_flair.csv', 1, 84);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2017/12/13 20:48:32
